...
namespace BLToolkit.Data.DataProvider
{
	...
	public abstract partial class DataProviderBase : IMappingSchemaProvider
	{
		...
		public virtual void SetParameterValue(IDbDataParameter parameter, object value)
		{
            ...
            // CUSTOM CODE
            else if (value != null && value.GetType().Name == "CourseEntityAttributes")
            {
                var attr = value as CourseEntityAttributes;
                parameter.Value = string.Format("\"code\" => {0}, \"description\" => {1}", attr.code, attr.description);
            }
			else
